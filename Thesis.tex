...
%\begin{table}[ht]
%  \begin{center}
%    \caption{Network sub-domains and their descriptions.}
...
\newpage
	...
	\hline
      ...
      Roads &  Technological & Network of roads where nodes are intersections and edges are roads.\\  \hline
      Subway &  Technological & Subway networks of major cities around the world.\\  \hline
      Airport &  Technological & Network of airports that are connected by flights between the airports.\\  \hline
      \label{tab:subdomain}
      \end{longtable}
%    \end{tabular}
%    \label{tab:subdomain}
