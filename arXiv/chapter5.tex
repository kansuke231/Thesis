...
\subfloat[No sampling]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/Domain/None/confusion_None.png}%
   \label{no_confusion}%
}
\subfloat[Random over-sampling]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/Domain/RandomOver/confusion_RandomOver.png}%
  \label{random_over_confusion}%
}
\subfloat[Random under-sampling]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/Domain/RandomUnder_26/confusion_RandomUnder.png}%
   \label{random_under_confusion}%
}
\subfloat[SMOTE]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/Domain/SMOTE/confusion_SMOTE.png}%
...
\centering 
\subfloat[No sampling]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/Domain/None/g.png}%
   \label{no_graph}%
}
\subfloat[Random over-sampling]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/Domain/RandomOver/g.png}%
  \label{random_over_graph}%
}
\subfloat[Random under-sampling]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/Domain/RandomUnder_26/g.png}%
   \label{random_under_graph}%
}
\subfloat[SMOTE]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/Domain/SMOTE/g.png}%
  \label{smote_graph}%
 }
...
\centering 
\subfloat[No sampling]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/SubDomain/None/confusion_sub_None.png}%
   \label{no_confusion_sub}%
}
\subfloat[Random over-sampling]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/SubDomain/RandomOver/confusion_sub_RandomOver.png}%
  \label{random_over_confusion_sub}%
}
\subfloat[Random under-sampling]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/SubDomain/RandomUnder_all5/confusion_sub_RandomUnder.png}%
   \label{random_under_confusion_sub}%
}
\subfloat[SMOTE]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/SubDomain/SMOTE/confusion_sub_SMOTE.png}%
...
\centering 
\subfloat[No sampling.]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/SubDomain/None/g.png}%
   \label{no_graph_sub_original}%
}
\subfloat[Random over-sampling.]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/SubDomain/RandomOver/g.png}%
  \label{random_over_graph_sub_original}%
}
\subfloat[Random under-sampling]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/SubDomain/RandomUnder_all5/g.png}%
   \label{random_under_graph_sub_original}%
}
\subfloat[SMOTE]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/SubDomain/SMOTE/g.png}%
...
\subfloat[No sampling. The number of communities is $4$]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/SubDomain/None/g_community.png}%
   \label{no_graph_sub_original}%
}
\subfloat[Random over-sampling. The number of communities is $4$.]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/SubDomain/RandomOver/g_community.png}%
  \label{random_over_graph_sub_original}%
}
\subfloat[Random under-sampling.  The number of communities is $3$.]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/SubDomain/RandomUnder_all5/g_community.png}%
   \label{random_under_graph_sub_original}%
}
\subfloat[SMOTE. The number of communities is $4$.]{%
  \includegraphics[width=0.5\columnwidth]{figs/similarity/SubDomain/SMOTE/g_community.png}%
  \label{smote_graph_sub_original}%
 }
