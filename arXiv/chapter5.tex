...
\subfloat[Protein interaction.  Average AUC score: 0.689]{%
  \includegraphics[width=0.3\columnwidth]{figs/one_by_many/protein/2d.png}%
   \label{protein_2d}%
}\qquad
\subfloat[Ecological food web. Average AUC score: 0.804]{%
  \includegraphics[width=0.3\columnwidth]{figs/one_by_many/food_web/2d.png}%
  \label{foodweb_2d}%
}
...
\subfloat[Metabolic. Average AUC score: 0.94]{%
  \includegraphics[width=0.3\columnwidth]{figs/one_by_many/metabolic/2d.png}%
   \label{metabolic_2d}%
}\qquad
\subfloat[Connectome. Average AUC score: 0.716]{%
  \includegraphics[width=0.3\columnwidth]{figs/one_by_many/connectome/2d.png}%
  \label{connectome_2d}%
}
...
\subfloat[Online social. Average AUC score: 0.94]{%
  \includegraphics[width=0.3\columnwidth]{figs/one_by_many/online_social/2d.png}%
   \label{online_social_2d}%
}\qquad
\subfloat[Communication. Average AUC score: 0.992]{%
  \includegraphics[width=0.3\columnwidth]{figs/one_by_many/communication/2d.png}%
...
\subfloat[Protein interaction. ]{%
  \includegraphics[width=0.3\columnwidth]{figs/one_by_many/protein/feature_importance.png}%
   \label{protein_feature}%
}\qquad
\subfloat[Ecological food web. ]{%
  \includegraphics[width=0.3\columnwidth]{figs/one_by_many/food_web/feature_importance.png}%
...
\subfloat[Metabolic.]{%
  \includegraphics[width=0.3\columnwidth]{figs/one_by_many/metabolic/feature_importance.png}%
   \label{metabolic_feature}%
}\qquad
\subfloat[Connectome.]{%
  \includegraphics[width=0.3\columnwidth]{figs/one_by_many/connectome/feature_importance.png}%
...
\subfloat[Online social.]{%
  \includegraphics[width=0.3\columnwidth]{figs/one_by_many/online_social/feature_importance.png}%
   \label{online_social_feature}%
}\qquad
\subfloat[Communication.]{%
  \includegraphics[width=0.3\columnwidth]{figs/one_by_many/communication/feature_importance.png}%
...
\subfloat[No sampling]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/Domain/None/confusion_None.png}%
   \label{no_confusion}%
}
\subfloat[Random over-sampling]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/Domain/RandomOver/confusion_RandomOver.png}%
...
\subfloat[Random under-sampling]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/Domain/RandomUnder_26/confusion_RandomUnder.png}%
   \label{random_under_confusion}%
}
\subfloat[SMOTE]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/Domain/SMOTE/confusion_SMOTE.png}%
...
\centering 
\subfloat[No sampling]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/Domain/None/g.png}%
   \label{no_graph}%
}
\subfloat[Random over-sampling]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/Domain/RandomOver/g.png}%
...
\subfloat[Random under-sampling]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/Domain/RandomUnder_26/g.png}%
   \label{random_under_graph}%
}
\subfloat[SMOTE]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/Domain/SMOTE/g.png}%
  \label{smote_graph}%
 }
...
\centering 
\subfloat[No sampling]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/SubDomain/None/confusion_sub_None.png}%
   \label{no_confusion_sub}%
}
\subfloat[Random over-sampling]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/SubDomain/RandomOver/confusion_sub_RandomOver.png}%
...
\subfloat[Random under-sampling]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/SubDomain/RandomUnder_all5/confusion_sub_RandomUnder.png}%
   \label{random_under_confusion_sub}%
}
\subfloat[SMOTE]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/SubDomain/SMOTE/confusion_sub_SMOTE.png}%
...
\centering 
\subfloat[No sampling.]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/SubDomain/None/g.png}%
   \label{no_graph_sub_original}%
}
\subfloat[Random over-sampling.]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/SubDomain/RandomOver/g.png}%
...
\subfloat[Random under-sampling]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/SubDomain/RandomUnder_all5/g.png}%
   \label{random_under_graph_sub_original}%
}
\subfloat[SMOTE]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/SubDomain/SMOTE/g.png}%
...
\subfloat[No sampling. The number of communities is $4$]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/SubDomain/None/g_community.png}%
   \label{no_graph_sub_original}%
}
\subfloat[Random over-sampling. The number of communities is $4$.]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/SubDomain/RandomOver/g_community.png}%
  \label{random_over_graph_sub_original}%
}
...
\subfloat[Random under-sampling.  The number of communities is $3$.]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/SubDomain/RandomUnder_all5/g_community.png}%
   \label{random_under_graph_sub_original}%
}
\subfloat[SMOTE. The number of communities is $4$.]{%
  \includegraphics[width=0.3\columnwidth]{figs/similarity/SubDomain/SMOTE/g_community.png}%
  \label{smote_graph_sub_original}%
 }
